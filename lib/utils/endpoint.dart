class Endpoint {
  ...
  static const String profil = "$baseUrlApi/profile";
  static const String absenToday = "$baseUrlApi/absenToday";
  static const String checkIn = "$baseUrlApi/absen";
  static const String checkOut = "$baseUrlApi/absen";
  static const String izin = "$baseUrlApi/izin";
  static const String statistik = "$baseUrlApi/statistikAbsen";
